...
function writeStructToTransaction (transaction, struct) {
 ...
 * @param {Y} y
 */
function integrateRemoteStructs (decoder, y) {
 ...
 * @param {Y} y
 */
function integrateRemoteStruct (decoder, y) {
  let reference = readVarUint(decoder);
  let Constr = getStruct(reference);
  let struct = new Constr();
  let decoderPos = decoder.pos;
...
const stringifyDeleteSet = (decoder) => {
  ...
  for (let i = 0; i < dsLength; i++) {
    ...
    const dvLength = readVarUint(decoder);
 ...
 * @param {Y} y
 */
const readSyncStep2 = (decoder, encoder, y) => {
 ...
 */
const stringifyMessage = (decoder, y) => {
 ...
 * @param {Y} y
 */
const readMessage = (decoder, encoder, y) => {
  const messageType = readVarUint(decoder);
  switch (messageType) {
    case messageYjsSyncStep1:
 ...
 * @private
 */
function typeObserver$2 (events) {
  this._mutualExclude(() => {
 ...
 * @private
 */
function domObserver$1 (mutations, _document) {
  this._mutualExclude(() => {
...
class DomBinding extends Binding {
  ...
  constructor (type, target, opts = {}) {
    ...
    this._domObserver = mutations => {
      domObserver$1.call(this, mutations, opts.document);
    };
...
exports.registerType = registerStruct;
exports.TextareaBinding = TextareaBinding;
exports.QuillBinding = QuillBinding;
exports.DomBinding = DomBinding;
exports.domToType = domToType;
exports.domsToTypes = domsToTypes;
exports.switchAssociation = switchAssociation;
exports.stringifyDeleteSet = stringifyDeleteSet;
exports.writeDeleteSet = writeDeleteSet;
exports.readDeleteSet = readDeleteSet;
exports.stringifyStateSet = stringifyStateSet;
exports.writeStateSet = writeStateSet;
exports.readStateSet = readStateSet;
exports.stringifyID = stringifyID;
exports.stringifyItemID = stringifyItemID;
exports.logItemHelper = logItemHelper;
exports.stringifyStructs = stringifyStructs;
exports.writeStructs = writeStructs;
exports.readStructs = readStructs;
exports.stringifySyncStep1 = stringifySyncStep1;
exports.writeSyncStep1 = writeSyncStep1;
exports.readSyncStep1 = readSyncStep1;
exports.stringifySyncStep2 = stringifySyncStep2;
exports.readSyncStep2 = readSyncStep2;
exports.stringifyUpdate = stringifyUpdate;
